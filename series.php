...
<div class="form-container" style="max-width: 500px">
    <h1 class="form-title">Add series</h1>
    <form class="form-design" action="add_series.php" method="POST" enctype="multipart/form-data">
        <!-- Series Name -->
        ...
        <div class="form-list-container">
            ...
            <?php while ($genre = $genresResult->fetch_assoc()): ?>
                <div class="form-list">
                    ...
                    <input type="checkbox" id="genre<?php echo $genre['genre_id']; ?>"
                           name="genre<?php echo $genre['genre_id']; ?>" value="<?php echo $genre['genre_id']; ?>">
                </div>
            <?php endwhile; ?>
        </div>
        <!-- Image Upload -->
        ...
        <?php if (isset($_SESSION["yearError"])): ?>
            <div class="message-box error"><?php echo $_SESSION["yearError"]; ?></div>
            <?php unset($_SESSION["yearError"]); ?>
        <?php endif; ?>
        <?php if (isset($_SESSION["nameError"])): ?>
            <div class="message-box error"><?php echo $_SESSION["nameError"]; ?></div>
            <?php unset($_SESSION["nameError"]); ?>
        <?php endif; ?>
        <?php if (isset($_GET["error"])): ?>
            <div class="message-box error"><?php echo $_GET["error"]; ?></div>
...
<script>
    function toggleEndYearVisibility() {
        ...
        const endYearContainer = document.getElementById('endYearContainer');
